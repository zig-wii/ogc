...
pub fn draw(box: Rectangle, color: u32) void {
    // Turn off texturing
...
pub fn draw_border(box: Rectangle, color: u32, width: u8) void {
    // Turn off texturing
    c.GX_SetTevOp(c.GX_TEVSTAGE0, c.GX_PASSCLR);
    c.GX_SetVtxDesc(c.GX_VA_TEX0, c.GX_NONE);
...
pub fn draw_sprite(box: Rectangle, coords: [4]f32, size: [2]f32) void {
